...
| File | Evidence |
|---|---|
| `01-real-dxf-library.png` | Real DXF library with 58 catalog cards and source thumbnails |
...
The automated R4 UI contract confirms 58 library cards, direct asset drag/drop,
9 semantic CAD component instances after the drop, 9 rendered vector images,
and lock/regenerate preserving the locked component coordinates.
